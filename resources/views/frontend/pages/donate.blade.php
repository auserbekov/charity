...
<section class="ftco-section bg-light">
  <div class="container">
    ...
    <br><a href="/donation-offer">Наша публичная оферта. Ознакомьтесь перед совершением оплаты</a>

    <br>

    <p><strong>Платежи. Оплата банковской картой онлайн</strong>
    <p>Наш сайт подключен к платежной системе Robokassa, и Вы можете совершить пожертвование банковской картой Visa или Mastercard, или другими способами. После подтверждения суммы пожертвования откроется защищенное окно с платежной страницей платежной системы Robokassa, где Вам необходимо ввести данные Вашей банковской карты. Для дополнительной аутентификации держателя карты используется протокол 3D Secure. Если Ваш Банк поддерживает данную технологию, Вы будете перенаправлены на его сервер для дополнительной идентификации. Информацию о правилах и методах дополнительной идентификации уточняйте в Банке, выдавшем Вам банковскую карту.</p>

 

    <p><strong>Гарантии безопасности</strong></p>
    <p>Платежная система Robokassa защищает и обрабатывает данные Вашей банковской карты по стандарту безопасности PCI DSS 3.0. Передача информации в платежный шлюз происходит с применением технологии шифрования SSL. Дальнейшая передача информации происходит по закрытым банковским сетям, имеющим наивысший уровень надежности. Robokassa не передает данные Вашей карты нам и иным третьим лицам. Для дополнительной аутентификации держателя карты используется протокол 3D Secure.</p>
