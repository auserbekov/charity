      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="/">Home</a></span> <span>Privacy</span></p>
    ...
    <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container">
        <div class="row mb-12 col-md-12">
          ...
          <p><strong>What personal information do we collect from the people that visit our website or blog?</strong></p>

          <p>When donating on our site, as appropriate, you may be asked to enter your name, email address, mailing address, credit card information or other details to help you with your experience.</p>

          <p><strong>When do we collect information?</strong></p>

          <p>We collect information from you when you donate, subscribe to a newsletter, fill out a form or enter information on our site.</p>
          ...
          <p>Your personal information is contained behind secured networks and is only accessible by a limited number of persons who have special access rights to such systems, and are required to keep the information confidential. In addition, all sensitive/credit information you supply is handled via a third-party online payment solution <a href="https://robokassa.com">Robokassa.com</a>.</p>

          <p>We implement a variety of security measures when a user donates, submits, or accesses their information to maintain the safety of your personal information.</p>
          ...
          <ul>
            <li>Help remember and process your website experience.</li>
          ...
          <p>You can request to have your information removed by clicking on the Contact Us menu item on this or the home page.</p>

          <p>Please note that we may maintain information about an individual donation transaction in order to complete that donation and for record keeping purposes.</p>
          ...
          <p><strong>Payments processors</strong></p>

          <p>We provide donations and/or services on our Website. In that case, we use third-party services for payment processing (e.g. payment processors).</p>
